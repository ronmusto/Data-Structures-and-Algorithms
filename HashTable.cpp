...
void HashTable::PrintAll() {
	...
	// initialize n to equal amount of nodes in hash table
  int n = nodes.size();
  // loop to iterate through all nodes of hash table and check if they have multiple entries
  for (int i = 0; i < n; ++i) {
    if (nodes[i].bid.bidId != "") {
